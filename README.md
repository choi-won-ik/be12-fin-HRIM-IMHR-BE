...
<p align="center">
  <img src="https://github.com/user-attachments/assets/ca508148-2c1d-4c4f-9bda-4be134b77f66" 
       width="600px"
...
- `부서별 ESG점수 관리` : Spring Batch를 사용하여 매달 첫째 주 월요일에 각 부서별 ESG활동 점수를 집계할 수 있고, 각 개인들은 우리 회사의 다른 부서의 ESG활동 점수와 이달에 가장 활동을
  많이한 사원을 확인할 수 있다.
...
> 이메일, 비밀번호, 닉네임, 프로필 이미지(선택)을 입력하며, 이메일/닉네임은 중복 불가
