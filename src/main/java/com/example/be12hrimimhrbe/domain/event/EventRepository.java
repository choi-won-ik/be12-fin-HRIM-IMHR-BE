...
//  이벤트 상세 조회와 삭제 쿼리
    Event findByIdxAndCompanyIdx(Long idx, Long companyIdx);

    Page<Event> findByTitleContainingIgnoreCaseAndCompanyIdx(String title, Long companyIdx, Pageable pageable);
}