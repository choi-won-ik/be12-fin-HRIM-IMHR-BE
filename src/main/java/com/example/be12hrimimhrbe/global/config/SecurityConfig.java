...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://www.imhr.kro.kr", "https://www.imhr.kro.kr", "https://www.imhr.p-e.kr"));
        ...
        http.authorizeHttpRequests(
                (auth) -> auth
                        .requestMatchers(
                                ...
                                "/error", "/swagger-ui/**", "/v3/api-docs/**","/actuator/prometheus",
